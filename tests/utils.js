...
Tinytest.add("Utils - get", function(test) {
  test.equal(Utils.get(obj, "a.a.a"), "a.a.a", "Can i use dot notation with expanded objects");
  test.equal(Utils.get(collapsed, "a.a.a"), "a.a.a", "Can i use dot notation with collapsed objects");
});
